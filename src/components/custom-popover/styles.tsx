...
export const StyledArrow = styled('span', {
...
})<StyledArrowProps>(({ placement, offset = 0, size = 0, theme: muiTheme }) => {
  const POSITION = -(size / 2) + 0.5;

  const theme: any = muiTheme;
  ...
  const backgroundStyles = (color: 'cyan' | 'red') => ({
    ...
    ...(color === 'cyan' && { backgroundPosition: 'top right' }),
    ...(color === 'red' && { backgroundPosition: 'bottom left' }),
  });
  ...
  return {
    ...
    ...(placement === 'top-left' && { ...alignmentStyles.top, left: offset }),
    ...(placement === 'top-center' && { ...alignmentStyles.top, ...alignmentStyles.hCenter }),
    ...(placement === 'top-right' && {
    ...
    ...(placement === 'bottom-center' && { ...alignmentStyles.bottom, ...alignmentStyles.hCenter }),
    ...(placement === 'bottom-right' && { ...alignmentStyles.bottom, right: offset }),
    ...(placement === 'left-top' && { ...alignmentStyles.left, top: offset }),
    ...
    ...(placement === 'right-bottom' && { ...alignmentStyles.right, bottom: offset }),
  };
});
